...
class PostSerializer(serializers.ModelSerializer):
    class Meta:
        model = Post
        fields = ['id','author','title', 'brief_content', 'content', 'image', 'status',
                  'category', 'relative_url', 'absolute_url', 'published_date']
    ...
    def to_representation(self, instance):
        ...
        rep['category']=CategorySerializer(instance=instance.category,
    ...
    def create(self, validated_data):
        validated_data['author']=Profile.objects.get(user=self.context['request'].user)
