...
class TestPasswordFlows:
    ...
    def test_change_password_requires_auth(self, api_client):
        ...
        payload = {"old_password": "x", "new_password": "Pass12345/", "new_password1": "Pass12345/"}

        resp = api_client.put(url, payload, format="json")
        assert resp.status_code in (401, 403)

    def test_change_password_wrong_old_password_returns_400(self, api_client, verified_user):
        """Wrong old password should return 400 with old_password error."""
        api_client.force_authenticate(user=verified_user)

        url = reverse("accounts:api-v1:change-password")
        payload = {"old_password": "wrong", "new_password": "NewPass12345/", "new_password1": "NewPass12345/"}
    ...
    def test_change_password_success_200_and_password_updates(self, api_client, verified_user):
        """Valid request should update password and return 200 success structure."""
        api_client.force_authenticate(user=verified_user)

        url = reverse("accounts:api-v1:change-password")
        payload = {"old_password": "Pass12345/", "new_password": "NewPass12345/", "new_password1": "NewPass12345/"}
    ...
    def test_reset_password_request_always_200(self, api_client, verified_user, mock_email_thread_start):
        """
    ...
    def test_reset_password_confirm_invalid_token_400(self, api_client):
        ...
        url = reverse("accounts:api-v1:reset-password-confirm", kwargs={"token": "invalid.token.value"})
        resp = api_client.post(url, {"password": "NewPass12345/", "password1": "NewPass12345/"}, format="json")
        assert resp.status_code == 400

    def test_reset_password_confirm_success_200_and_password_updates(self, api_client, verified_user):
